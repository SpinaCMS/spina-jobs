...
ActiveRecord::Schema.define(version: 2018_08_22_201854) do
  ...
  create_table "spina_jobs_job_applications", id: :serial, force: :cascade do |t|
  ...
  create_table "spina_jobs_job_roles", id: :serial, force: :cascade do |t|
    t.string "title"
    t.text "introduction"
    t.text "description"
  ...
  add_foreign_key "spina_jobs_job_applications", "spina_jobs_job_roles", column: "job_role_id"
end
